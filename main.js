...
var sudoku = new Array(
  ...
  //Changes made by me in this section

  //Contains current state of sudoku board
  var sudoku_copy;


  //Changes by me ends here
  ...
  function input(x) {
    if (x.value == undefined) {
      if (
        ...
        sudoku_copy[x]=sudoku[x];
        console.log(sudoku_copy);
        if(sudoku===sudoku_copy){
          document.create('winner');
        }
      } else {
